...
public class ReservationFragment extends Fragment implements MyReserveListAdapter.OnMyReserveListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //pass all reservation with status reserved, cancelled
        ...
        ref1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myReserveListAdapter = new MyReserveListAdapter(getContext(), list, ReservationFragment.this::onMyReserveClick);
                recyclerView.addItemDecoration(new DividerItemDecoration(recyclerView.getContext(), DividerItemDecoration.VERTICAL));
